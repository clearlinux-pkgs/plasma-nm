...
Version  : 6.3.2
Release  : 119
URL      : https://download.kde.org/stable/plasma/6.3.2/plasma-nm-6.3.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.2/plasma-nm-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/plasma-nm-6.3.2.tar.xz.sig
...
%setup -q -n plasma-nm-6.3.2
cd %{_builddir}/plasma-nm-6.3.2
pushd ..
cp -a plasma-nm-6.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741066885
mkdir -p clr-build
pushd clr-build
...
%files locales -f plasma_applet_org.kde.plasma.networkmanagement.lang -f plasmanetworkmanagement-kcm.lang -f plasmanetworkmanagement-kded.lang -f plasmanetworkmanagement-libs.lang -f plasmanetworkmanagement_iodineui.lang -f plasmanetworkmanagement_l2tpui.lang -f plasmanetworkmanagement_openconnectui.lang -f plasmanetworkmanagement_openvpnui.lang -f plasmanetworkmanagement_strongswanui.lang -f plasmanetworkmanagement_vpncui.lang -f plasmanetworkmanagement_fortisslvpnui.lang -f plasmanetworkmanagement_libreswanui.lang -f plasmanetworkmanagement_pptpui.lang -f plasmanetworkmanagement_sshui.lang -f plasmanetworkmanagement_sstpui.lang
%defattr(-,root,root,-)
