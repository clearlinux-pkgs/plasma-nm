...
Source0  : https://download.kde.org/stable/plasma/5.26.3/plasma-nm-5.26.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.3/plasma-nm-5.26.3.tar.xz.sig
...
%prep
%setup -q -n plasma-nm-5.26.3
cd %{_builddir}/plasma-nm-5.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667927368
mkdir -p clr-build
pushd clr-build
