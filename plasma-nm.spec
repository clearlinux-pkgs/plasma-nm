...
Version  : 6.1.3
Release  : 108
URL      : https://download.kde.org/stable/plasma/6.1.3/plasma-nm-6.1.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.3/plasma-nm-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/plasma-nm-6.1.3.tar.xz.sig
...
%setup -q -n plasma-nm-6.1.3
cd %{_builddir}/plasma-nm-6.1.3
pushd ..
cp -a plasma-nm-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721154358
mkdir -p clr-build
pushd clr-build
