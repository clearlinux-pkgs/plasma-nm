...
Source0  : https://download.kde.org/stable/plasma/5.14.1/plasma-nm-5.14.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.1/plasma-nm-5.14.1.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1539740032
mkdir -p clr-build
pushd clr-build
%cmake ..
