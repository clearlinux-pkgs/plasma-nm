...
Version  : 6.3.5
Release  : 122
URL      : https://download.kde.org/stable/plasma/6.3.5/plasma-nm-6.3.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.5/plasma-nm-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/plasma-nm-6.3.5.tar.xz.sig
...
%setup -q -n plasma-nm-6.3.5
cd %{_builddir}/plasma-nm-6.3.5
pushd ..
cp -a plasma-nm-6.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747176684
mkdir -p clr-build
pushd clr-build
...
%files locales -f plasma_applet_org.kde.plasma.networkmanagement.lang -f plasmanetworkmanagement-kcm.lang -f plasmanetworkmanagement-kded.lang -f plasmanetworkmanagement-libs.lang -f plasmanetworkmanagement_fortisslvpnui.lang -f plasmanetworkmanagement_iodineui.lang -f plasmanetworkmanagement_l2tpui.lang -f plasmanetworkmanagement_libreswanui.lang -f plasmanetworkmanagement_openconnectui.lang -f plasmanetworkmanagement_openvpnui.lang -f plasmanetworkmanagement_pptpui.lang -f plasmanetworkmanagement_sshui.lang -f plasmanetworkmanagement_sstpui.lang -f plasmanetworkmanagement_strongswanui.lang -f plasmanetworkmanagement_vpncui.lang
%defattr(-,root,root,-)
