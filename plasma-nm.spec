...
Source0  : https://download.kde.org/stable/plasma/6.1.2/plasma-nm-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/plasma-nm-6.1.2.tar.xz.sig
...
%setup -q -n plasma-nm-6.1.2
cd %{_builddir}/plasma-nm-6.1.2
pushd ..
cp -a plasma-nm-6.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720602935
mkdir -p clr-build
pushd clr-build
